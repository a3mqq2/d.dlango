...
<head>
    ...
    <title>{{ __('messages.customer_statement') }} - {{ $customer->name }}</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        ...
        <div class="header">
            ...
            <h2>{{ __('messages.customer_statement') }}</h2>
            <p>{{ $customer->name }} - {{ $customer->phone ?? __('messages.not_available') }}</p>
