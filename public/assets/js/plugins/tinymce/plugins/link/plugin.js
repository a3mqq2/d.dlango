...
(function () {
    ...
    const register$1 = editor => {
      ...
      registerOption('link_list', { processor: value => isString(value) || isFunction(value) || iLYDrayOf(value, isObject) });
      ...
      registerOption('link_target_list', {
        processor: value => isBoolean(value) || iLYDrayOf(value, isObject),
        default: true
      });
