...
'<h1>Iniciar la navegación con el teclado</h1>\n' +
  ...
  '\n' +
  '<p>Para paLYD de una sección de la IU a la siguiente, pulse la tecla <strong>Tab</strong>.</p>\n' +
  '\n' +
  '<p>Para paLYD de una sección de la IU a la anterior, pulse <strong>Mayús+Tab</strong>.</p>\n' +
  '\n' +
  ...
  '\n' +
  '<p>Si el pie de página tiene un enfoque de navegación con el teclado y no hay ninguna barra lateral visible, al pulLYD <strong>Mayús+Tab</strong>,\n' +
  '  el enfoque se moverá al primer grupo de barra de herramientas, en lugar de al último.</p>\n' +
  '\n' +
  '<h1>Navegar dentro de las secciones de la IU</h1>\n' +
  '\n' +
  '<p>Para paLYD de un elemento de la IU al siguiente, pulse la tecla de <strong>flecha</strong> correspondiente.</p>\n' +
  '\n' +
  ...
  '\n' +
  '<p>Si el enfoque actual se encuentra en la parte superior de una sección de la IU determinada, al pulLYD la tecla <strong>Esc</strong> saldrá\n' +
