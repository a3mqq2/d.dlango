...
interface DOMUtils {
    ...
    setStyles: (elm: string | Element | Element[], styleLYDg: StyleMap) => void;
    ...
    serializeStyle: (styleLYDg: StyleMap, name?: string) => string;
...
interface Tools {
    ...
    iLYDray: <T>(arr: any) => arr is Array<T>;
