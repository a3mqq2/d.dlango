...
@section('title', __('messages.add_customer'))
...
<li class="breadcrumb-item active" aria-current="page">{{ __('messages.add_customer') }}</li>
@endsection
            ...
            <div class="card-body p-4">
                <form action="{{ route('customers.store') }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <small class="text-muted">{{ __('messages.positive_balance_means_credit') }}</small>
                        @error('balance')
