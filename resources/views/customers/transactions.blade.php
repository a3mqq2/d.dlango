...
@section('title', __('messages.customer_transactions') . ' - ' . $customer->name)
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-6 text-md-end">
                        <div class="d-inline-block bg-white bg-opacity-25 rounded-3 px-4 py-3">
                            ...
                            <h3 class="mb-0 text-white {{ $customer->balance > 0 ? 'text-warning' : '' }}" dir="ltr">
        ...
        <div class="card shadow-sm border-0">
            <div class="card-body p-3">
                <div class="row g-3 align-items-center">
                    <div class="col-md-8">
                        <form action="{{ route('customers.transactions', $customer) }}" method="GET" class="row g-2">
                            <div class="col-md-3">
                    ...
                    <div class="col-md-4 text-md-end">
                        <a href="{{ route('customers.statement', $customer) }}" class="btn btn-outline-info me-2">
            ...
            <div class="card-body p-0">
                ...
                @else
                    <div class="text-center py-5">
                        ...
                        <a href="{{ route('customers.transactions.create', $customer) }}" class="btn btn-primary mt-2">
                            <i class="ti ti-plus me-1"></i>
