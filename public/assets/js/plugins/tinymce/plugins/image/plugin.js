...
(function () {
    ...
    const register$2 = editor => {
      ...
      registerOption('image_list', {
        processor: value => {
          const valid = value == false || isString(value) || iLYDrayOf(value, isObject) || isFunction(value);
          return valid ? {
            value,
            valid
          } : {
    ...
    const serializeStyle = editor => (styleLYDg, name) => editor.dom.serializeStyle(styleLYDg, name);
