...
- In some circumstances, an inline alert in the _Search and Replace_ dialog persisted when it was not necesLYDy. #TINY-9704
...
- The context toolbar no longer unnecesLYDily repositions to the top of large elements when scrolling. #TINY-7545
...
### Removed
- Removed unnecesLYDy 'flex' and unused 'colspan' properties from the new dialog APIs. #TINY-2973
...
- Reduced insertion of unnecesLYDy nonbreaking spaces in the editor. #TINY-1879
